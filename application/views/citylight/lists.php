                            ...
                            <div class="form-group glocation">
                             ...
                             <div class="form-group glocation">
                               <ul>
                      			...
                      			<?php /*		<li><input type="checkbox" name="property-type[]" value="Mill" <?php if(isset($filters['propertytype']) && in_array("Mill",$filters['propertytype'])) echo "checked"; ?>/>Mill <span style="font-size:10px;">[<?php if(isset($proptypeinfo["Mill"]))echo $proptypeinfo["Mill"]["popularity"]; else echo "0"; ?> Mill]</span></li>
