<header>
   ...
   <form name="searchHouses" action="#" method="get" id="sea" class="search">
      <fieldset>
          ...
          <input type="search" name="houses" id="search1" value="Search for address, town or area." />
          <input type="submit" value="For Sale" name="action" id="forsale" class="button-submit" />
          <input type="submit" value="To Rent" name="action" id="torent" class="button-submit" />
      </fieldset>
    </form>